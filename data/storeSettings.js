...
export const DEFAULT_STORE_SETTINGS = {
  ...
  paymentSettings: {
    ...
    codInstructions: "Order confirm karne ke liye Rs. 250 advance delivery charges zaroori hain. Payment ke baad transaction ka screenshot proof ke taur par WhatsApp (+92 305 3530008) par bhejein. Baaki amount delivery ke waqt courier ko cash mein adaa karein.",
    bankName: "",
    bankTitle: "",
    bankAccountNumber: "",
    bankIban: "",
    whatsappNumber: "",
    instructions: "Full payment bank account mein transfer karein. Payment ke baad transaction ka screenshot proof ke taur par WhatsApp (+92 305 3530008) par bhejein. Dispatch payment verification ke baad start hoga.",
  },
  shippingZones: [
