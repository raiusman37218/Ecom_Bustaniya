...
export const DEFAULT_HOMEPAGE_SECTIONS = [
  ...
  },
  {
    ...
    subtitle: "Our most ordered styles, selected automatically from delivered orders.",
  },
  {
    id: "newsletter",
    type: "newsletter",
...
export const DEFAULT_STORE_SETTINGS = {
  ...
  paymentSettings: {
    ...
    advancePercent: 20,
    codInstructions: "Pay the order amount to the courier when your order arrives. Our team may call to confirm your order before dispatch.",
    bankName: "",
    bankTitle: "",
    bankAccountNumber: "",
    bankIban: "",
    instructions: "Transfer the advance amount after placing your order, use the exact order reference, then share your transaction ID with our team. Dispatch starts after verification.",
  },
  shippingZones: [
