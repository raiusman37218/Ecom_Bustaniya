...
export async function resolveCredentials() {
  ...
  const requestedPixelId = dbPixelId || envPixelId || ACTIVE_META_PIXEL_ID;
  // Older settings/env values must never send events to the retired dataset.
  const pixelId = requestedPixelId === RETIRED_META_PIXEL_ID ? ACTIVE_META_PIXEL_ID : requestedPixelId;
