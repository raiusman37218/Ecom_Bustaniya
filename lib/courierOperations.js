...
export async function getCourierOperations() {
  ...
  return {
    ...
    shipments: orders.filter((order) => {
      const trackingNumber = order.courier_tracking_number || order.tracking_number;
