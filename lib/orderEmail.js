...
export async function sendOrderConfirmation({
  ...
  await transporter.sendMail({
    from: `"Lisette" <${process.env.GMAIL_USER}>`,
    to: recipient,
    subject: `Lisette order confirmed — ${order.order_number}`,
      ...
      <div style="margin:0;padding:36px 16px;background:#f7f3eb;font-family:Arial,sans-serif;color:#173d2a">
        <div style="max-width:620px;margin:auto;background:#fff;border-top:5px solid #173d2a">
          <div style="padding:34px 34px 24px;background:#dcffb8">
            <p style="margin:0 0 8px;color:#9b4968;font-size:12px;letter-spacing:2px">LISETTE</p>
          ...
          <div style="padding:30px 34px">
            ...
            <p style="line-height:1.7;color:#6f4b59">Thank you for shopping with Lisette. Your order is confirmed and ready for courier processing.</p>
