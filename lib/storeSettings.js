...
function normalizeFinanceTransactions(value) {
  return (Array.isArray(value) ? value : []).map((item, index) => ({
    ...
    type: ["business_expense", "owner_withdrawal", "owner_investment", "supplier_payment", "postex_bank_receipt", "other_income"].includes(item?.type) ? item.type : "business_expense",
...
export async function updateStoreSettings(settings = {}) {
  ...
  const record = {
    ...
    category_section_style: categorySectionStyle,
