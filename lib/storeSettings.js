...
function normalizeDomainSettings(value) {
  ...
  return {
    ...
    metaPixelId: String(source.metaPixelId ?? defaults.metaPixelId ?? "").trim().slice(0, 120),
    metaCapiAccessToken: String(source.metaCapiAccessToken ?? defaults.metaCapiAccessToken ?? "").trim().slice(0, 500),
  };
}
