...
function normalizeStoreSettings(record = {}) {
  ...
  return {
    ...
    heroDesktopImage: String(record.hero_desktop_image || DEFAULT_STORE_SETTINGS.heroDesktopImage),
    heroMobileImage: String(record.hero_mobile_image || DEFAULT_STORE_SETTINGS.heroMobileImage),
...
export async function updateStoreSettings(settings = {}) {
  ...
  const record = {
    ...
    hero_desktop_image: String(settings.heroDesktopImage || DEFAULT_STORE_SETTINGS.heroDesktopImage),
    hero_mobile_image: String(settings.heroMobileImage || DEFAULT_STORE_SETTINGS.heroMobileImage),
