...
export async function updateStoreSettings(settings = {}) {
  ...
  const record = {
    ...
    announcements: { items: announcements, financeTransactions, financeAllocation, financeFixedCosts, productionBatches, inventorySources, inventoryMaterials, supplierBills },
