...
export const REGIONS = {
  pk: {
    ...
    contact: {
      phone: process.env.NEXT_PUBLIC_CONTACT_PHONE || "+92 322 7811989",
      email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "support@bustaniya.com",
      whatsapp: "923227811989",
      whatsappDisplay: "+92 322 7811989",
  ...
  uk: {
    ...
    contact: {
      ...
      whatsapp: process.env.NEXT_PUBLIC_UK_WHATSAPP || "923227811989",
      whatsappDisplay: process.env.NEXT_PUBLIC_UK_WHATSAPP_DISPLAY || "+92 322 7811989",
