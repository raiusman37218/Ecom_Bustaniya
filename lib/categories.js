...
const DEFAULT_CATEGORY_IMAGE = "/lisette-hero.png";
const LISETTE_CATEGORY_IMAGES = {
  bras: "/lisette-bra-01.png",
  panties: "/lisette-panties-01.png",
  "lingerie-sets": "/lisette-lounge-set-01.png",
  sleepwear: "/lisette-sleepwear-01.png",
};
...
export function normalizeCategoryRecord(record = {}) {
  ...
  return {
    ...
    name,
    slug,
    description: record.description || `Shop ${name.toLowerCase()} online from Lisette with delivery across Pakistan.`,
    image: optimizedImageUrl(LISETTE_CATEGORY_IMAGES[slug] || record.image || DEFAULT_CATEGORY_IMAGE),
    parentSlug,
