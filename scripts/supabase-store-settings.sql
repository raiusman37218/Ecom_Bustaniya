create table if not exists public.store_settings (
  ...
  announcement_text text not null default 'Orders are confirmed at checkout. Free delivery on full advance payment.',
  announcement_link_label text default 'Shop now',
  announcement_link_href text default '#products',
  announcements jsonb not null default '[{"id":"default-payment-policy","text":"Orders are confirmed at checkout. Free delivery on full advance payment.","linkLabel":"Shop now","linkHref":"#products","enabled":true}]'::jsonb,
...
alter table public.store_settings
  ...
  add column if not exists announcement_text text not null default 'Orders are confirmed at checkout. Free delivery on full advance payment.',
  ...
  add column if not exists announcements jsonb not null default '[{"id":"default-payment-policy","text":"Orders are confirmed at checkout. Free delivery on full advance payment.","linkLabel":"Shop now","linkHref":"#products","enabled":true}]'::jsonb;
...
insert into public.store_settings (
  ...
  1,
  true,
  'Orders are confirmed at checkout. Free delivery on full advance payment.',
  'Shop now',
  '#products',
  '[{"id":"default-payment-policy","text":"Orders are confirmed at checkout. Free delivery on full advance payment.","linkLabel":"Shop now","linkHref":"#products","enabled":true}]'::jsonb
